        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              <Link href="https://www.facebook.com/profile.php?id=61577046339862&rdid=w5tTFOPTIKikgqoJ&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1As5GGk48s%2F#" className="text-gray-600 hover:text-red-600">
              ...
              <Link href="https://www.instagram.com/curryinhurry_sherwood_park?igsh=MWc4YW1wM3J2bzltdQ%3D%3D" className="text-gray-600 hover:text-red-600">
